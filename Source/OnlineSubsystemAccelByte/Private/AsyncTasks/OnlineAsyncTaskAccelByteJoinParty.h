 ...
 */
class FOnlineAsyncTaskAccelByteJoinParty : public FOnlineAsyncTaskAccelByte, public TSelfPtr<FOnlineAsyncTaskAccelByteJoinParty, ESPMode::ThreadSafe>
{
public:
	 ...
	 */
	FOnlineAsyncTaskAccelByteJoinParty(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const IOnlinePartyJoinInfo& InOnlinePartyJoinInfo, const FOnJoinPartyComplete& InDelegate);
	
	/**
	 * Constructor for joining a party through a party code
	 */
	FOnlineAsyncTaskAccelByteJoinParty(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const FString& InPartyCode, const FOnJoinPartyComplete& InDelegate);
