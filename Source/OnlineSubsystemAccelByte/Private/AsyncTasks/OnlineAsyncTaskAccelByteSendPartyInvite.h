 ...
 */
class FOnlineAsyncTaskAccelByteSendPartyInvite : public FOnlineAsyncTaskAccelByte
{
public:

	FOnlineAsyncTaskAccelByteSendPartyInvite(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const FOnlinePartyId& InPartyId, const FPartyInvitationRecipient& InRecipient, const FOnSendPartyInvitationComplete& InDelegate);
