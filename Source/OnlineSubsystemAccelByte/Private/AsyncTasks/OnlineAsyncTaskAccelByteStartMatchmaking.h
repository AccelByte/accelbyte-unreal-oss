...
class FOnlineAsyncTaskAccelByteStartMatchmaking : public FOnlineAsyncTaskAccelByte
{
public:

	/** Constructor to setup the StartMatchmaking task */
	FOnlineAsyncTaskAccelByteStartMatchmaking(FOnlineSubsystemAccelByte* const InABInterface, const TArray<TSharedRef<const FUniqueNetId>>& InLocalPlayers, FName InSessionName, const FOnlineSessionSettings& InNewSessionSettings, TSharedRef<FOnlineSessionSearch>& InSearchSettings);
