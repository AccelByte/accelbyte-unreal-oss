...
#include "OnlineAsyncTaskAccelByteLeaveParty.h"
#include "OnlineSubsystemAccelByte.h"
#include "OnlinePartyInterfaceAccelByte.h"
#include "OnlineSessionInterfaceAccelByte.h"

FOnlineAsyncTaskAccelByteLeaveParty::FOnlineAsyncTaskAccelByteLeaveParty(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const FOnlinePartyId& InPartyId, bool InBSynchronizeLeave, const FOnLeavePartyComplete& InDelegate)
...
void FOnlineAsyncTaskAccelByteLeaveParty::Initialize()
{
	Super::Initialize();
...
void FOnlineAsyncTaskAccelByteLeaveParty::Finalize()
{
...
void FOnlineAsyncTaskAccelByteLeaveParty::TriggerDelegates()
{
	AB_OSS_ASYNC_TASK_TRACE_BEGIN(TEXT("bWasSuccessful: %s"), LOG_BOOL_FORMAT(bWasSuccessful));
...
void FOnlineAsyncTaskAccelByteLeaveParty::OnLeavePartyResponse(const FAccelByteModelsLeavePartyResponse& Result)
{
