...
#include "OnlineAsyncTaskAccelByteRegisterDedicatedSession.h"
...
FOnlineAsyncTaskAccelByteRegisterDedicatedSession::FOnlineAsyncTaskAccelByteRegisterDedicatedSession(FOnlineSubsystemAccelByte* const InABInterface, int32 InHostingPlayerNum, FName InSessionName, const FOnlineSessionSettings& InNewSessionSettings, bool InRegisterToSessionBrowser)
...
void FOnlineAsyncTaskAccelByteRegisterDedicatedSession::Initialize()
{
	Super::Initialize();
...
void FOnlineAsyncTaskAccelByteRegisterDedicatedSession::Finalize()
{
...
void FOnlineAsyncTaskAccelByteRegisterDedicatedSession::TriggerDelegates()
{
...
void FOnlineAsyncTaskAccelByteRegisterDedicatedSession::OnAuthenticateServerComplete(bool bAuthenticationSuccessful)
{
...
void FOnlineAsyncTaskAccelByteRegisterDedicatedSession::RegisterAccelByteDedicatedServer()
{
	AB_OSS_ASYNC_TASK_TRACE_BEGIN(TEXT(""));
...
void FOnlineAsyncTaskAccelByteRegisterDedicatedSession::GetRegisterIpAddress(FString& IpString, int32& Port)
{
	AB_OSS_ASYNC_TASK_TRACE_BEGIN(TEXT(""));
...
void FOnlineAsyncTaskAccelByteRegisterDedicatedSession::CreateGameSession()
{
	AB_OSS_ASYNC_TASK_TRACE_BEGIN(TEXT(""));
	...
	AccelByte::THandler<FAccelByteModelsSessionBrowserData> OnSessionCreateSuccessDelegate =
		AccelByte::THandler<FAccelByteModelsSessionBrowserData>::CreateRaw(
			this,
			&FOnlineAsyncTaskAccelByteRegisterDedicatedSession::OnSessionCreateSuccess
		);
...
void FOnlineAsyncTaskAccelByteRegisterDedicatedSession::OnSessionCreateSuccess(const FAccelByteModelsSessionBrowserData& Data)
{
	AB_OSS_ASYNC_TASK_TRACE_BEGIN(TEXT("SessionName: %s"), *SessionName.ToString());
...
void FOnlineAsyncTaskAccelByteRegisterDedicatedSession::RegisterCreatedGameSession(FString SessionId)
{
	AB_OSS_ASYNC_TASK_TRACE_BEGIN(TEXT(""));
