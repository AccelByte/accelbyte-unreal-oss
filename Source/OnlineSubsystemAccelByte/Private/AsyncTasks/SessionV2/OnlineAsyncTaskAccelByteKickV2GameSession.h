...
class FOnlineAsyncTaskAccelByteKickV2GameSession
	: public FOnlineAsyncTaskAccelByte
	, public AccelByte::TSelfPtr<FOnlineAsyncTaskAccelByteKickV2GameSession, ESPMode::ThreadSafe>
{
public:
	FOnlineAsyncTaskAccelByteKickV2GameSession(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const FName& InSessionName, const FUniqueNetId& InPlayerIdToKick, const FOnKickPlayerComplete& InDelegate);
...
protected:
	...
	{
		return TEXT("FOnlineAsyncTaskAccelByteKickV2GameSession");
	}
