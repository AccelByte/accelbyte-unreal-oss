...
void FOnlineAsyncTaskAccelByteRetrieveDedicatedV1SessionInfo::OnQueryMatchSessionSuccess(const FAccelByteModelsSessionBrowserData& Result)
{
...
void FOnlineAsyncTaskAccelByteRetrieveDedicatedV1SessionInfo::OnGetSessionIdSuccess(const FAccelByteModelsServerSessionResponse& Result)
{
	...
	THandler<FAccelByteModelsSessionBrowserData> OnQuerySessionStatusSuccess = THandler<FAccelByteModelsSessionBrowserData>::CreateRaw(this, &FOnlineAsyncTaskAccelByteRetrieveDedicatedV1SessionInfo::OnQueryMatchSessionSuccess);
