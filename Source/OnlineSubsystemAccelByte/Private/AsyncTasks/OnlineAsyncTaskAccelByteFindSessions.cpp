...
#include "OnlineAsyncTaskAccelByteFindSessions.h"
#include "OnlineSubsystemAccelByte.h"
#include "OnlineIdentityInterfaceAccelByte.h"
#include "Misc/DefaultValueHelper.h"
#include "OnlineSubsystemAccelByteDefines.h"

FOnlineAsyncTaskAccelByteFindSessions::FOnlineAsyncTaskAccelByteFindSessions(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InSearchingPlayerId, const TSharedRef<FOnlineSessionSearch>& InSearchSettings)
...
void FOnlineAsyncTaskAccelByteFindSessions::Initialize()
{
	Super::Initialize();
	...
	THandler<FAccelByteModelsSessionBrowserGetResult> OnSessionBrowserFindSuccessDelegate = THandler<FAccelByteModelsSessionBrowserGetResult>::CreateRaw(this, &FOnlineAsyncTaskAccelByteFindSessions::OnSessionBrowserFindSuccess);
...
void FOnlineAsyncTaskAccelByteFindSessions::Finalize()
{
...
void FOnlineAsyncTaskAccelByteFindSessions::TriggerDelegates()
{
...
void FOnlineAsyncTaskAccelByteFindSessions::OnSessionBrowserFindSuccess(const FAccelByteModelsSessionBrowserGetResult& Result)
{
