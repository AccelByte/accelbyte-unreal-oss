...
#include "OnlineAsyncTaskAccelByteGetCurrencyListV2.h"
...
FOnlineAsyncTaskAccelByteGetCurrencyListV2::FOnlineAsyncTaskAccelByteGetCurrencyListV2(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, bool bInAlwaysRequestToService)
...
void FOnlineAsyncTaskAccelByteGetCurrencyListV2::Initialize()
{
	TRY_PIN_SUBSYSTEM();
	...
	if (WalletInterface.IsValid())
	{
		...
		{	
			...
			OnGetCurrencyListSuccessDelegate = TDelegateUtils<THandler<TArray<FAccelByteModelsCurrencyList>>>::CreateThreadSafeSelfPtr(this, &FOnlineAsyncTaskAccelByteGetCurrencyListV2::OnGetCurrencyListSuccess);
			OnGetCurrencyListErrorDelegate = TDelegateUtils<FErrorHandler>::CreateThreadSafeSelfPtr(this, &FOnlineAsyncTaskAccelByteGetCurrencyListV2::OnGetCurrencyListError);
...
void FOnlineAsyncTaskAccelByteGetCurrencyListV2::TriggerDelegates()
{
	TRY_PIN_SUBSYSTEM();
...
void FOnlineAsyncTaskAccelByteGetCurrencyListV2::OnGetCurrencyListSuccess(const TArray<FAccelByteModelsCurrencyList>& Result)
{
	TRY_PIN_SUBSYSTEM();
...
void FOnlineAsyncTaskAccelByteGetCurrencyListV2::OnGetCurrencyListError(int32 ErrorCode, const FString& ErrorMessage)
{
