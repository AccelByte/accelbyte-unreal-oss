...
#include "OnlineAsyncTaskAccelByteUpdatePartyData.h"
#include "OnlineSubsystemAccelByte.h"
#include "Core/AccelByteRegistry.h"
#include "Api/AccelByteLobbyApi.h"
#include "OnlinePartyInterfaceAccelByte.h"

FOnlineAsyncTaskAccelByteUpdatePartyData::FOnlineAsyncTaskAccelByteUpdatePartyData(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const FOnlinePartyId& InPartyId, const FName& InNamespace, const FOnlinePartyData& InPartyData)
...
void FOnlineAsyncTaskAccelByteUpdatePartyData::Initialize()
{
	Super::Initialize();
	...
	THandler<FAccelByteModelsPartyDataNotif> OnWritePartyStorageSuccessDelegate = THandler<FAccelByteModelsPartyDataNotif>::CreateRaw(this, &FOnlineAsyncTaskAccelByteUpdatePartyData::OnWritePartyStorageSuccess);
	FErrorHandler OnWritePartyStorageErrorDelegate = FErrorHandler::CreateRaw(this, &FOnlineAsyncTaskAccelByteUpdatePartyData::OnWritePartyStorageError);
...
void FOnlineAsyncTaskAccelByteUpdatePartyData::Finalize()
{
...
void FOnlineAsyncTaskAccelByteUpdatePartyData::TriggerDelegates()
{
	AB_OSS_ASYNC_TASK_TRACE_BEGIN(TEXT("bWasSuccessful: %s"), LOG_BOOL_FORMAT(bWasSuccessful));
...
void FOnlineAsyncTaskAccelByteUpdatePartyData::OnWritePartyStorageSuccess(const FAccelByteModelsPartyDataNotif& Result)
{
...
void FOnlineAsyncTaskAccelByteUpdatePartyData::OnWritePartyStorageError(int32 ErrorCode, const FString& ErrorMessage)
{
	SetLastUpdateTimeToCurrentTime();
