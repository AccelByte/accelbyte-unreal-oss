...
class FOnlineAsyncTaskAccelByteRegisterDedicatedSession : public FOnlineAsyncTaskAccelByte
{
public:

	/** Constructor to setup the task to register a dedicated session */
	FOnlineAsyncTaskAccelByteRegisterDedicatedSession(FOnlineSubsystemAccelByte* const InABInterface, int32 InHostingPlayerNum, FName InSessionName, const FOnlineSessionSettings& InNewSessionSettings, bool InRegisterToSessionBrowser);
