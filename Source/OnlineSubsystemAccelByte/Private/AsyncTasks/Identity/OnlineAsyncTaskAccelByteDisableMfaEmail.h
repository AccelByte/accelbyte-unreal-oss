...
class FOnlineAsyncTaskAccelByteDisableMfaEmail
	: public FOnlineAsyncTaskAccelByte
	, public AccelByte::TSelfPtr<FOnlineAsyncTaskAccelByteDisableMfaEmail, ESPMode::ThreadSafe>
{
public:
	FOnlineAsyncTaskAccelByteDisableMfaEmail(FOnlineSubsystemAccelByte* const InABSubsystem
...
protected:
	...
	{
		return TEXT("FOnlineAsyncTaskAccelByteDisableMfaEmail");
	}
...
private:
	...
	void DisableMfaEmail();
	void OnDisableMfaEmailSuccess();
	void OnDisableMfaEmailError(const int32 ErrorCode, const FString& ErrorMessage);
};
