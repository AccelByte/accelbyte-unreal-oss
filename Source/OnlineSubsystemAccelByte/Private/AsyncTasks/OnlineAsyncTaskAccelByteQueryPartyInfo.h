 ...
 */
class FOnlineAsyncTaskAccelByteQueryPartyInfo : public FOnlineAsyncTaskAccelByte, public TSelfPtr<FOnlineAsyncTaskAccelByteQueryPartyInfo, ESPMode::ThreadSafe>
{
public:

	FOnlineAsyncTaskAccelByteQueryPartyInfo(FOnlineSubsystemAccelByte* const InABInterface, int32 InLocalUserNum, const FString& InPartyId, const TArray<FString>& InMembers, const FOnQueryPartyInfoComplete& InDelegate);

	FOnlineAsyncTaskAccelByteQueryPartyInfo(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InUserId, const FString& InPartyId, const TArray<FString>& InMembers, const FOnQueryPartyInfoComplete& InDelegate);
