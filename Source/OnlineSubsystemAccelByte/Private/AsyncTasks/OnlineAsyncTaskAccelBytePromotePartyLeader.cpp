...
#include "OnlineAsyncTaskAccelBytePromotePartyLeader.h"
#include "Core/AccelByteRegistry.h"
#include "Api/AccelByteLobbyApi.h"
#include "OnlinePartyInterfaceAccelByte.h"

FOnlineAsyncTaskAccelBytePromotePartyLeader::FOnlineAsyncTaskAccelBytePromotePartyLeader(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const FOnlinePartyId& InPartyId, const FUniqueNetId& InTargetMemberId, const FOnPromotePartyMemberComplete& InDelegate)
...
void FOnlineAsyncTaskAccelBytePromotePartyLeader::Initialize()
{
	Super::Initialize();
	...
	AccelByte::Api::Lobby::FPartyPromoteLeaderResponse OnPromotePartyMemberResponseDelegate = AccelByte::Api::Lobby::FPartyPromoteLeaderResponse::CreateRaw(this, &FOnlineAsyncTaskAccelBytePromotePartyLeader::OnPromotePartyMemberResponse);
...
void FOnlineAsyncTaskAccelBytePromotePartyLeader::Finalize()
{
...
void FOnlineAsyncTaskAccelBytePromotePartyLeader::TriggerDelegates()
{
	AB_OSS_ASYNC_TASK_TRACE_BEGIN(TEXT("bWasSuccessful: %s"), LOG_BOOL_FORMAT(bWasSuccessful));
...
void FOnlineAsyncTaskAccelBytePromotePartyLeader::OnPromotePartyMemberResponse(const FAccelByteModelsPartyPromoteLeaderResponse& Result)
{
