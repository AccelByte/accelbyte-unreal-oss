 ...
 */
class FOnlineAsyncTaskAccelByteBulkQueryCurentUserBinaryRecords
	: public FOnlineAsyncTaskAccelByte
	, public AccelByte::TSelfPtr<FOnlineAsyncTaskAccelByteBulkQueryCurentUserBinaryRecords, ESPMode::ThreadSafe>
{
public:
	FOnlineAsyncTaskAccelByteBulkQueryCurentUserBinaryRecords(FOnlineSubsystemAccelByte* const InABInterface
...
protected:
	...
	{
		return TEXT("OnlineAsyncTaskAccelByteBulkQueryCurentUserBinaryRecords");
	}
