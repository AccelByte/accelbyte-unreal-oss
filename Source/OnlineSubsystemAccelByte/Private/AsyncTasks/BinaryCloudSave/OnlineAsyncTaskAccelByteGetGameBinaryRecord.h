 ...
 */
class FOnlineAsyncTaskAccelByteGetGameBinaryRecord
	: public FOnlineAsyncTaskAccelByte
	, public AccelByte::TSelfPtr<FOnlineAsyncTaskAccelByteGetGameBinaryRecord, ESPMode::ThreadSafe>
{
public:
	FOnlineAsyncTaskAccelByteGetGameBinaryRecord(FOnlineSubsystemAccelByte* const InABInterface
...
protected:
	...
	{
		return TEXT("OnlineAsyncTaskAccelByteGetGameBinaryRecord");
	}
