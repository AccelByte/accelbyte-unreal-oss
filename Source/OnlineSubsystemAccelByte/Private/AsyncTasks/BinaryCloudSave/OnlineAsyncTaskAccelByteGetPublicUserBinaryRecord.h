 ...
 */
class FOnlineAsyncTaskAccelByteGetPublicUserBinaryRecord
	: public FOnlineAsyncTaskAccelByte
	, public AccelByte::TSelfPtr<FOnlineAsyncTaskAccelByteGetPublicUserBinaryRecord, ESPMode::ThreadSafe>
{
public:
	FOnlineAsyncTaskAccelByteGetPublicUserBinaryRecord(FOnlineSubsystemAccelByte* const InABInterface
