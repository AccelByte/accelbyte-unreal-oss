 ...
 */
class FOnlineAsyncTaskAccelByteQueryGameBinaryRecords
	: public FOnlineAsyncTaskAccelByte
	, public AccelByte::TSelfPtr<FOnlineAsyncTaskAccelByteQueryGameBinaryRecords, ESPMode::ThreadSafe>
{
public:
	FOnlineAsyncTaskAccelByteQueryGameBinaryRecords(FOnlineSubsystemAccelByte* const InABInterface
...
protected:
	...
	{
		return TEXT("OnlineAsyncTaskAccelByteQueryGameBinaryRecords");
	}
