...
#include "OnlineAsyncTaskAccelByteBulkGetPublicUserBinaryRecords.h"
...
FOnlineAsyncTaskAccelByteBulkGetPublicUserBinaryRecords::FOnlineAsyncTaskAccelByteBulkGetPublicUserBinaryRecords(FOnlineSubsystemAccelByte* const InABInterface 
...
void FOnlineAsyncTaskAccelByteBulkGetPublicUserBinaryRecords::Initialize()
{
	Super::Initialize();
	...
	OnSuccessDelegate = TDelegateUtils<THandler<FAccelByteModelsListUserBinaryRecords>>::CreateThreadSafeSelfPtr(this, &FOnlineAsyncTaskAccelByteBulkGetPublicUserBinaryRecords::OnSuccess);
	OnErrorDelegate = TDelegateUtils<FErrorHandler>::CreateThreadSafeSelfPtr(this, &FOnlineAsyncTaskAccelByteBulkGetPublicUserBinaryRecords::OnError);
	...
	BinaryCloudSave->BulkGetPublicUserBinaryRecords(Keys, TargetUserId, OnSuccessDelegate, OnErrorDelegate);

	AB_OSS_ASYNC_TASK_TRACE_END(TEXT(""));
}

void FOnlineAsyncTaskAccelByteBulkGetPublicUserBinaryRecords::Finalize() 
{
	TRY_PIN_SUBSYSTEM();
...
void FOnlineAsyncTaskAccelByteBulkGetPublicUserBinaryRecords::TriggerDelegates()
{
	TRY_PIN_SUBSYSTEM();
...
void FOnlineAsyncTaskAccelByteBulkGetPublicUserBinaryRecords::OnSuccess(FAccelByteModelsListUserBinaryRecords const& Result)
{
...
void FOnlineAsyncTaskAccelByteBulkGetPublicUserBinaryRecords::OnError(int32 Code, const FString& ErrorMessage)
{
	TaskOnlineError = EOnlineErrorResult::RequestFailure;
