...
#include "OnlineAsyncTaskAccelByteKickPartyMember.h"
#include "OnlinePartyInterfaceAccelByte.h"
#include "OnlineSessionInterfaceAccelByte.h"
#include "Core/AccelByteRegistry.h"
#include "Api/AccelByteLobbyApi.h"

FOnlineAsyncTaskAccelByteKickPartyMember::FOnlineAsyncTaskAccelByteKickPartyMember(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const FOnlinePartyId& InPartyId, const FUniqueNetId& InTargetMemberId, const FOnKickPartyMemberComplete& InDelegate)
...
void FOnlineAsyncTaskAccelByteKickPartyMember::Initialize()
{
	Super::Initialize();
	...
	AccelByte::Api::Lobby::FPartyKickResponse OnKickPartyMemberResponseDelegate = AccelByte::Api::Lobby::FPartyKickResponse::CreateRaw(this, &FOnlineAsyncTaskAccelByteKickPartyMember::OnKickPartyMemberResponse);
...
void FOnlineAsyncTaskAccelByteKickPartyMember::Finalize()
{
...
void FOnlineAsyncTaskAccelByteKickPartyMember::TriggerDelegates()
{
	AB_OSS_ASYNC_TASK_TRACE_BEGIN(TEXT("bWasSuccessful: %s"), LOG_BOOL_FORMAT(bWasSuccessful));
...
void FOnlineAsyncTaskAccelByteKickPartyMember::OnKickPartyMemberResponse(const FAccelByteModelsKickPartyMemberResponse& Result)
{
