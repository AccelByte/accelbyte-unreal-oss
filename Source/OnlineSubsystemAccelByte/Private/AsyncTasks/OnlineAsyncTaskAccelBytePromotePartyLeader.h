 ...
 */
class FOnlineAsyncTaskAccelBytePromotePartyLeader : public FOnlineAsyncTaskAccelByte
{
public:

	FOnlineAsyncTaskAccelBytePromotePartyLeader(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const FOnlinePartyId& InPartyId, const FUniqueNetId& InTargetMemberId, const FOnPromotePartyMemberComplete& InDelegate);
