...
#include "OnlineAsyncTaskAccelByteGetPartyInviteInfo.h"
#include "OnlinePartyInterfaceAccelByte.h"
#include "Core/AccelByteRegistry.h"
#include "Api/AccelByteUserApi.h"

FOnlineAsyncTaskAccelByteGetPartyInviteInfo::FOnlineAsyncTaskAccelByteGetPartyInviteInfo(FOnlineSubsystemAccelByte* const InABInterface, const TSharedRef<const FUniqueNetIdAccelByteUser>& InUserId, const FAccelByteModelsPartyGetInvitedNotice& InNotification)
...
void FOnlineAsyncTaskAccelByteGetPartyInviteInfo::Initialize()
{
	Super::Initialize();
	...
	FOnQueryUsersComplete OnQueryNotificationSenderCompleteDelegate = FOnQueryUsersComplete::CreateRaw(this, &FOnlineAsyncTaskAccelByteGetPartyInviteInfo::OnQueryNotificationSenderComplete);
	UserStore->QueryUsersByAccelByteIds(LocalUserNum, { Notification.From }, OnQueryNotificationSenderCompleteDelegate, true);

	AB_OSS_ASYNC_TASK_TRACE_END(TEXT(""));
}

void FOnlineAsyncTaskAccelByteGetPartyInviteInfo::Finalize()
{
...
void FOnlineAsyncTaskAccelByteGetPartyInviteInfo::OnQueryNotificationSenderComplete(bool bIsSuccessful, TArray<TSharedRef<FAccelByteUserInfo>> UsersQueried)
{
