 ...
 */
class FOnlineAsyncTaskAccelByteCreateParty : public FOnlineAsyncTaskAccelByte
{
public:

	FOnlineAsyncTaskAccelByteCreateParty(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const FOnlinePartyTypeId InPartyTypeId, const FPartyConfiguration& InPartyConfig, const FOnCreatePartyComplete& InDelegate);
