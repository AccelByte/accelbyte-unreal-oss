...
#include "OnlineAsyncTaskAccelByteSendPartyInvite.h"
#include "OnlineSubsystemAccelByte.h"
#include "OnlinePartyInterfaceAccelByte.h"
#include "Api/AccelByteLobbyApi.h"
#include "Core/AccelByteRegistry.h"

FOnlineAsyncTaskAccelByteSendPartyInvite::FOnlineAsyncTaskAccelByteSendPartyInvite(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const FOnlinePartyId& InPartyId, const FPartyInvitationRecipient& InRecipient, const FOnSendPartyInvitationComplete& InDelegate)
...
void FOnlineAsyncTaskAccelByteSendPartyInvite::Initialize()
{
	Super::Initialize();
	...
	AccelByte::Api::Lobby::FPartyInviteResponse OnPartyInviteResponseDelegate = AccelByte::Api::Lobby::FPartyInviteResponse::CreateRaw(this, &FOnlineAsyncTaskAccelByteSendPartyInvite::OnPartyInviteResponse);
...
void FOnlineAsyncTaskAccelByteSendPartyInvite::Finalize()
{
...
void FOnlineAsyncTaskAccelByteSendPartyInvite::TriggerDelegates()
{
	AB_OSS_ASYNC_TASK_TRACE_BEGIN(TEXT("bWasSuccessful: %s"), LOG_BOOL_FORMAT(bWasSuccessful));
...
void FOnlineAsyncTaskAccelByteSendPartyInvite::OnPartyInviteResponse(const FAccelByteModelsPartyInviteResponse& Result)
{
