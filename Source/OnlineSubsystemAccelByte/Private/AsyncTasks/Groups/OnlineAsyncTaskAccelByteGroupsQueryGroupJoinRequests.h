...
class FOnlineAsyncTaskAccelByteGroupsQueryGroupJoinRequests : public FOnlineAsyncTaskAccelByte, public AccelByte::TSelfPtr<FOnlineAsyncTaskAccelByteGroupsQueryGroupJoinRequests, ESPMode::ThreadSafe>
{
public:
...
protected:
	...
	{
		return TEXT("FOnlineAsyncTaskAccelByteGroupsQueryGroupJoinRequests");
	}

private:
	void OnQueryGroupJoinRequestsSuccess(const FAccelByteModelsGetMemberRequestsListResponse& Result);
	THandler<FAccelByteModelsGetMemberRequestsListResponse> OnSuccessDelegate;

	void OnQueryGroupJoinRequestsError(int32 ErrorCode, const FString& ErrorMessage);
