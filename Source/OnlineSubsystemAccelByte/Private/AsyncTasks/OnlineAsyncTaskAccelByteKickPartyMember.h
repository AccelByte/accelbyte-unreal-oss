 ...
 */
class FOnlineAsyncTaskAccelByteKickPartyMember : public FOnlineAsyncTaskAccelByte
{
public:

	FOnlineAsyncTaskAccelByteKickPartyMember(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const FOnlinePartyId& InPartyId, const FUniqueNetId& InTargetMemberId, const FOnKickPartyMemberComplete& InDelegate);
