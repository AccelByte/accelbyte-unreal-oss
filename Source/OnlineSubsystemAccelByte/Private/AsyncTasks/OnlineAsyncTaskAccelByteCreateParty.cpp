...
#include "OnlineAsyncTaskAccelByteCreateParty.h"
...
FOnlineAsyncTaskAccelByteCreateParty::FOnlineAsyncTaskAccelByteCreateParty(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const FOnlinePartyTypeId InPartyTypeId, const FPartyConfiguration& InPartyConfig, const FOnCreatePartyComplete& InDelegate)
...
void FOnlineAsyncTaskAccelByteCreateParty::Initialize()
{
	Super::Initialize();
	...
	AccelByte::Api::Lobby::FPartyInfoResponse OnGetPartyInfoResponseDelegate = AccelByte::Api::Lobby::FPartyInfoResponse::CreateRaw(this, &FOnlineAsyncTaskAccelByteCreateParty::OnGetPartyInfoResponse);
...
void FOnlineAsyncTaskAccelByteCreateParty::Finalize()
{
...
void FOnlineAsyncTaskAccelByteCreateParty::TriggerDelegates()
{
	AB_OSS_ASYNC_TASK_TRACE_BEGIN(TEXT("bWasSuccessful: %s"), LOG_BOOL_FORMAT(bWasSuccessful));
...
void FOnlineAsyncTaskAccelByteCreateParty::OnGetPartyInfoResponse(const FAccelByteModelsInfoPartyResponse& Result)
{
	...
	AccelByte::Api::Lobby::FPartyCreateResponse OnCreatePartyResponseDelegate = AccelByte::Api::Lobby::FPartyCreateResponse::CreateRaw(this, &FOnlineAsyncTaskAccelByteCreateParty::OnCreatePartyResponse);
...
void FOnlineAsyncTaskAccelByteCreateParty::OnCreatePartyResponse(const FAccelByteModelsCreatePartyResponse& Result)
{
	...
	else
	{
		...
		AccelByte::Api::Lobby::FPartyGetCodeResponse OnPartyGetCodeResponseDelegate = AccelByte::Api::Lobby::FPartyGetCodeResponse::CreateRaw(this, &FOnlineAsyncTaskAccelByteCreateParty::OnPartyGetCodeResponse);
		ApiClient->Lobby.SetPartyGetCodeResponseDelegate(OnPartyGetCodeResponseDelegate);
		ApiClient->Lobby.SendPartyGetCodeRequest();
	}
}

void FOnlineAsyncTaskAccelByteCreateParty::OnPartyGetCodeResponse(const FAccelByteModelsPartyGetCodeResponse& Result)
{
	if (Result.Code != TEXT("0"))
	{
