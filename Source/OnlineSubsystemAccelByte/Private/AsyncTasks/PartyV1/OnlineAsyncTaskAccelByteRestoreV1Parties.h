 ...
 */
class FOnlineAsyncTaskAccelByteRestoreV1Parties : public FOnlineAsyncTaskAccelByte
{
public:

	FOnlineAsyncTaskAccelByteRestoreV1Parties(FOnlineSubsystemAccelByte* const InABInterface, const FUniqueNetId& InLocalUserId, const FOnRestorePartiesComplete& InCompletionDelegate);
