...
#define SETTING_SESSION_NUM_PUBLIC_CONNECTIONS FName(TEXT("NUMPUBLICCONNECTIONS"))
#define SETTING_SESSION_NUM_PRIVATE_CONNECTIONS FName(TEXT("NUMPRIVATECONNECTIONS"))
